"""Global configuration for the Sonar causal pruning study."""
...
# -- Data ----------------------------------------------------------------------
DATASET_NAME = "sonar"        # OpenML data_id=40 (Sonar, Mines vs Rocks)
TEST_SIZE    = 0.2

# -- Model / training ----------------------------------------------------------
HIDDEN_DIMS      = [32, 16]   # smaller net: Sonar has only ~166 training rows
BATCH_SIZE       = 64
EPOCHS_BASELINE  = 40
EPOCHS_FINETUNE  = 15
LEARNING_RATE    = 1e-3
